...
import com.example.kade.apiservices.nextmatch.GetDataNextMatch
...
class NextMatchViewModel : ViewModel() {
    ...
    internal lateinit var dataApi: GetDataNextMatch
    ...
    fun setData(idLeague: String) {
        fetchData(idLeague)
    }
    private fun fetchData(id: String) {
        composite = CompositeDisposable()
        dataApi = RetroClient.instance.create(GetDataNextMatch::class.java)
        composite?.addAll(dataApi.getData(id)
